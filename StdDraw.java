...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static double mouseReleaseX = 0;
    private static double mouseReleaseY = 0;
    ...
    *************************************************************************/
    ...
    public void mouseReleased(MouseEvent e) {
        synchronized (mouseLock) {
            mousePressed = false;
            // SIMON
            mouseReleaseX = StdDraw.userX(e.getX());
            mouseReleaseY = StdDraw.userY(e.getY());
			mouseRelease = true;
        }
    }
...
// SIMON
	public static void resetMouseInput(){
		mouseRelease = false;
		mousePressed = false;
	}
    ...
    public static double mouseReleaseX() {
        synchronized (mouseLock) {
            return mouseReleaseX;
        }
    }
    public static double mouseReleaseY() {
        synchronized (mouseLock) {
